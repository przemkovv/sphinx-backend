...
using Sphinx::Db::Meta::optional_tag;
using Sphinx::Db::Meta::primarykey_tag;
using Sphinx::Db::Meta::autoincrement_tag;
}
...
struct User : Sphinx::Db::Meta::Entity<User> {
  ...
  BOOST_HANA_DEFINE_STRUCT(User,
                           (Column<0, User, std::int32_t, primarykey_tag>, id),
...
struct Course : Sphinx::Db::Meta::Entity<Course> {
  ...
  BOOST_HANA_DEFINE_STRUCT(
      Course,
      (Column<0, Course, std::int32_t, primarykey_tag>, id),
...
struct Module : Sphinx::Db::Meta::Entity<Module> {
  ...
  BOOST_HANA_DEFINE_STRUCT(
      Module,
      (Column<0, Module, std::int32_t, primarykey_tag>, id),
